...
import { IncubusClient } from '../dist/client';
import { stringToPath } from '@cosmjs/crypto';
import { Account } from '@xblackfury/utils';
import {
...
const TEST_ADDRESS="incubus1dhqmhaksj5qw4ays64pp9mff3fwkxtugvn0at5"
const OTHER_TEST_ADDRESS="incubus1s0aj6f7hgzr3gfcmm9xz0lg0442qdq9su9llq0"
const RPC_NODE_URL="https://rpc.nft-devnet.incubus.network/"
...
const connect = async (mnemonic?: string) => {
  ...
  return new IncubusClient<typeof modules>({
    connection: {
      type: 'tendermint',
