...
export const aminoConverter: { [key: string]: AminoConverter } = {
  '/incubus.merkledrop.v1beta1.MsgCreate': {
    aminoType: 'go-incubus/merkledrop/MsgCreate',
    toAmino: ({
      owner,
      merkleRoot,
      startHeight,
  ...
  '/incubus.merkledrop.v1beta1.MsgClaim': {
    aminoType: 'go-incubus/merkledrop/MsgClaim',
    toAmino: ({
      sender,
      merkledropId,
      index,
