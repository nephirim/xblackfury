...
export interface Indexes {
  $type: 'incubus.merkledrop.v1beta1.Indexes';
  merkledropId: Long;
  index: Long[];
}

export interface GenesisState {
  $type: 'incubus.merkledrop.v1beta1.GenesisState';
...
export const Indexes = {
  $type: 'incubus.merkledrop.v1beta1.Indexes' as const,
...
export const GenesisState = {
  $type: 'incubus.merkledrop.v1beta1.GenesisState' as const,
