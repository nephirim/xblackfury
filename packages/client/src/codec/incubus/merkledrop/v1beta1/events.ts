...
export interface EventCreate {
  $type: 'incubus.merkledrop.v1beta1.EventCreate';
  owner: string;
  merkledropId: Long;
}

export interface EventClaim {
  $type: 'incubus.merkledrop.v1beta1.EventClaim';
  merkledropId: Long;
  index: Long;
  coin?: Coin;
}
...
export interface EventWithdraw {
  $type: 'incubus.merkledrop.v1beta1.EventWithdraw';
  merkledropId: Long;
  coin?: Coin;
}
...
export const EventCreate = {
  $type: 'incubus.merkledrop.v1beta1.EventCreate' as const,
...
export const EventClaim = {
  $type: 'incubus.merkledrop.v1beta1.EventClaim' as const,
...
export const EventWithdraw = {
  $type: 'incubus.merkledrop.v1beta1.EventWithdraw' as const,
