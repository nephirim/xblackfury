...
export interface Params {
  $type: 'incubus.merkledrop.v1beta1.Params';
  creationFee?: Coin;
}

function createBaseParams(): Params {
  return { $type: 'incubus.merkledrop.v1beta1.Params', creationFee: undefined };
}

export const Params = {
  $type: 'incubus.merkledrop.v1beta1.Params' as const,
