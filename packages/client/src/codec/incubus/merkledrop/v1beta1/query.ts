...
export const protobufPackage = 'incubus.merkledrop.v1beta1';

export interface QueryMerkledropRequest {
  $type: 'incubus.merkledrop.v1beta1.QueryMerkledropRequest';
  id: Long;
}

export interface QueryMerkledropResponse {
  $type: 'incubus.merkledrop.v1beta1.QueryMerkledropResponse';
  merkledrop?: Merkledrop;
}

export interface QueryIndexClaimedRequest {
  $type: 'incubus.merkledrop.v1beta1.QueryIndexClaimedRequest';
  id: Long;
  index: Long;
}

export interface QueryIndexClaimedResponse {
  $type: 'incubus.merkledrop.v1beta1.QueryIndexClaimedResponse';
  isClaimed: boolean;
}

/** QueryParametersRequest is request type for the Query/Parameters RPC method */
export interface QueryParamsRequest {
  $type: 'incubus.merkledrop.v1beta1.QueryParamsRequest';
}

/** QueryParametersResponse is response type for the Query/Parameters RPC method */
export interface QueryParamsResponse {
  $type: 'incubus.merkledrop.v1beta1.QueryParamsResponse';
  params?: Params;
}
...
export const QueryMerkledropRequest = {
  $type: 'incubus.merkledrop.v1beta1.QueryMerkledropRequest' as const,
...
export const QueryMerkledropResponse = {
  $type: 'incubus.merkledrop.v1beta1.QueryMerkledropResponse' as const,
...
export const QueryIndexClaimedRequest = {
  $type: 'incubus.merkledrop.v1beta1.QueryIndexClaimedRequest' as const,
...
export const QueryIndexClaimedResponse = {
  $type: 'incubus.merkledrop.v1beta1.QueryIndexClaimedResponse' as const,
...
function createBaseQueryParamsRequest(): QueryParamsRequest {
  return { $type: 'incubus.merkledrop.v1beta1.QueryParamsRequest' };
}

export const QueryParamsRequest = {
  $type: 'incubus.merkledrop.v1beta1.QueryParamsRequest' as const,
...
export const QueryParamsResponse = {
  $type: 'incubus.merkledrop.v1beta1.QueryParamsResponse' as const,
...
export class QueryClientImpl implements Query {
  ...
  Merkledrop(
    ...
    const promise = this.rpc.request(
      'incubus.merkledrop.v1beta1.Query',
      'Merkledrop',
      data,
    );
