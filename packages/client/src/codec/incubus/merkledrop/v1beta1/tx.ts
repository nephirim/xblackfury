...
export interface MsgCreate {
  $type: 'incubus.merkledrop.v1beta1.MsgCreate';
...
export interface MsgCreateResponse {
  $type: 'incubus.merkledrop.v1beta1.MsgCreateResponse';
  owner: string;
  id: Long;
}

export interface MsgClaim {
  $type: 'incubus.merkledrop.v1beta1.MsgClaim';
  sender: string;
  merkledropId: Long;
  index: Long;
  amount: string;
...
export interface MsgClaimResponse {
  $type: 'incubus.merkledrop.v1beta1.MsgClaimResponse';
  id: Long;
  index: Long;
  amount: string;
}
...
export const MsgCreate = {
  $type: 'incubus.merkledrop.v1beta1.MsgCreate' as const,
...
export const MsgCreateResponse = {
  $type: 'incubus.merkledrop.v1beta1.MsgCreateResponse' as const,
...
export const MsgClaim = {
  $type: 'incubus.merkledrop.v1beta1.MsgClaim' as const,
...
export const MsgClaimResponse = {
  $type: 'incubus.merkledrop.v1beta1.MsgClaimResponse' as const,
...
export class MsgClientImpl implements Msg {
  ...
  Create(request: MsgCreate): Promise<MsgCreateResponse> {
    ...
    const promise = this.rpc.request(
      'incubus.merkledrop.v1beta1.Msg',
      'Create',
      data,
    );
