...
export interface UpdateFeesProposal {
  $type: 'incubus.fantoken.v1beta1.UpdateFeesProposal';
  title: string;
  description: string;
  issueFee?: Coin;
  mintFee?: Coin;
...
export interface UpdateFeesProposalWithDeposit {
  $type: 'incubus.fantoken.v1beta1.UpdateFeesProposalWithDeposit';
  title: string;
  description: string;
  issueFee: string;
  mintFee: string;
...
export const UpdateFeesProposal = {
  $type: 'incubus.fantoken.v1beta1.UpdateFeesProposal' as const,
...
export const UpdateFeesProposalWithDeposit = {
  $type: 'incubus.fantoken.v1beta1.UpdateFeesProposalWithDeposit' as const,
