...
export const protobufPackage = 'incubus.fantoken.v1beta1';

export interface EventIssue {
  $type: 'incubus.fantoken.v1beta1.EventIssue';
  denom: string;
}

export interface EventDisableMint {
  $type: 'incubus.fantoken.v1beta1.EventDisableMint';
  denom: string;
}

export interface EventMint {
  $type: 'incubus.fantoken.v1beta1.EventMint';
  recipient: string;
  coin: string;
}

export interface EventBurn {
  $type: 'incubus.fantoken.v1beta1.EventBurn';
  sender: string;
  coin: string;
}

export interface EventSetAuthority {
  $type: 'incubus.fantoken.v1beta1.EventSetAuthority';
  denom: string;
  oldAuthority: string;
  newAuthority: string;
}
...
export interface EventSetMinter {
  $type: 'incubus.fantoken.v1beta1.EventSetMinter';
  denom: string;
  oldMinter: string;
  newMinter: string;
}
...
export interface EventSetUri {
  $type: 'incubus.fantoken.v1beta1.EventSetUri';
  denom: string;
}

function createBaseEventIssue(): EventIssue {
  return { $type: 'incubus.fantoken.v1beta1.EventIssue', denom: '' };
}

export const EventIssue = {
  $type: 'incubus.fantoken.v1beta1.EventIssue' as const,
...
function createBaseEventDisableMint(): EventDisableMint {
  return { $type: 'incubus.fantoken.v1beta1.EventDisableMint', denom: '' };
}

export const EventDisableMint = {
  $type: 'incubus.fantoken.v1beta1.EventDisableMint' as const,
...
export const EventMint = {
  $type: 'incubus.fantoken.v1beta1.EventMint' as const,
...
function createBaseEventBurn(): EventBurn {
  return { $type: 'incubus.fantoken.v1beta1.EventBurn', sender: '', coin: '' };
}

export const EventBurn = {
  $type: 'incubus.fantoken.v1beta1.EventBurn' as const,
...
export const EventSetAuthority = {
  $type: 'incubus.fantoken.v1beta1.EventSetAuthority' as const,
...
export const EventSetMinter = {
  $type: 'incubus.fantoken.v1beta1.EventSetMinter' as const,
...
function createBaseEventSetUri(): EventSetUri {
  return { $type: 'incubus.fantoken.v1beta1.EventSetUri', denom: '' };
}

export const EventSetUri = {
  $type: 'incubus.fantoken.v1beta1.EventSetUri' as const,
