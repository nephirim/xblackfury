...
export const protobufPackage = 'incubus.fantoken';
...
export interface MsgIssueResponse {
  $type: 'incubus.fantoken.MsgIssueResponse';
}
...
export interface MsgDisableMintResponse {
  $type: 'incubus.fantoken.MsgDisableMintResponse';
}
...
export interface MsgMintResponse {
  $type: 'incubus.fantoken.MsgMintResponse';
}
...
export interface MsgBurnResponse {
  $type: 'incubus.fantoken.MsgBurnResponse';
}
...
export interface MsgSetMinterResponse {
  $type: 'incubus.fantoken.MsgSetMinterResponse';
}
...
export interface MsgSetAuthorityResponse {
  $type: 'incubus.fantoken.MsgSetAuthorityResponse';
}
...
export interface MsgSetUriResponse {
  $type: 'incubus.fantoken.MsgSetUriResponse';
}
...
export const MsgIssue = {
  $type: 'incubus.fantoken.MsgIssue' as const,
...
function createBaseMsgIssueResponse(): MsgIssueResponse {
  return { $type: 'incubus.fantoken.MsgIssueResponse' };
}

export const MsgIssueResponse = {
  $type: 'incubus.fantoken.MsgIssueResponse' as const,
...
function createBaseMsgDisableMint(): MsgDisableMint {
  return { $type: 'incubus.fantoken.MsgDisableMint', denom: '', minter: '' };
}

export const MsgDisableMint = {
  $type: 'incubus.fantoken.MsgDisableMint' as const,
...
function createBaseMsgDisableMintResponse(): MsgDisableMintResponse {
  return { $type: 'incubus.fantoken.MsgDisableMintResponse' };
}

export const MsgDisableMintResponse = {
  $type: 'incubus.fantoken.MsgDisableMintResponse' as const,
...
export const MsgMint = {
  $type: 'incubus.fantoken.MsgMint' as const,
...
function createBaseMsgMintResponse(): MsgMintResponse {
  return { $type: 'incubus.fantoken.MsgMintResponse' };
}

export const MsgMintResponse = {
  $type: 'incubus.fantoken.MsgMintResponse' as const,
...
function createBaseMsgBurn(): MsgBurn {
  return { $type: 'incubus.fantoken.MsgBurn', coin: undefined, sender: '' };
}

export const MsgBurn = {
  $type: 'incubus.fantoken.MsgBurn' as const,
...
function createBaseMsgBurnResponse(): MsgBurnResponse {
  return { $type: 'incubus.fantoken.MsgBurnResponse' };
}

export const MsgBurnResponse = {
  $type: 'incubus.fantoken.MsgBurnResponse' as const,
...
export const MsgSetMinter = {
  $type: 'incubus.fantoken.MsgSetMinter' as const,
...
function createBaseMsgSetMinterResponse(): MsgSetMinterResponse {
  return { $type: 'incubus.fantoken.MsgSetMinterResponse' };
}

export const MsgSetMinterResponse = {
  $type: 'incubus.fantoken.MsgSetMinterResponse' as const,
...
export const MsgSetAuthority = {
  $type: 'incubus.fantoken.MsgSetAuthority' as const,
...
function createBaseMsgSetAuthorityResponse(): MsgSetAuthorityResponse {
  return { $type: 'incubus.fantoken.MsgSetAuthorityResponse' };
}

export const MsgSetAuthorityResponse = {
  $type: 'incubus.fantoken.MsgSetAuthorityResponse' as const,
...
export const MsgSetUri = {
  $type: 'incubus.fantoken.MsgSetUri' as const,
...
function createBaseMsgSetUriResponse(): MsgSetUriResponse {
  return { $type: 'incubus.fantoken.MsgSetUriResponse' };
}

export const MsgSetUriResponse = {
  $type: 'incubus.fantoken.MsgSetUriResponse' as const,
...
export class MsgClientImpl implements Msg {
  ...
  Issue(request: MsgIssue): Promise<MsgIssueResponse> {
    ...
    const promise = this.rpc.request('incubus.fantoken.Msg', 'Issue', data);
    return promise.then(data => MsgIssueResponse.decode(new _m0.Reader(data)));
  }

  Mint(request: MsgMint): Promise<MsgMintResponse> {
    const data = MsgMint.encode(request).finish();
    const promise = this.rpc.request('incubus.fantoken.Msg', 'Mint', data);
    return promise.then(data => MsgMintResponse.decode(new _m0.Reader(data)));
  }

  Burn(request: MsgBurn): Promise<MsgBurnResponse> {
    const data = MsgBurn.encode(request).finish();
    const promise = this.rpc.request('incubus.fantoken.Msg', 'Burn', data);
  ...
  SetMinter(request: MsgSetMinter): Promise<MsgSetMinterResponse> {
    ...
    const promise = this.rpc.request('incubus.fantoken.Msg', 'SetMinter', data);
    return promise.then(data =>
  ...
  SetUri(request: MsgSetUri): Promise<MsgSetUriResponse> {
    ...
    const promise = this.rpc.request('incubus.fantoken.Msg', 'SetUri', data);
