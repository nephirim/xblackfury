...
export interface Metadata {
  $type: 'incubus.fantoken.v1beta1.Metadata';
...
export interface FanToken {
  $type: 'incubus.fantoken.v1beta1.FanToken';
...
export const Metadata = {
  $type: 'incubus.fantoken.v1beta1.Metadata' as const,
...
export const FanToken = {
  $type: 'incubus.fantoken.v1beta1.FanToken' as const,
