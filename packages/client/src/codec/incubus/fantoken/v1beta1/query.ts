...
export interface QueryFanTokensResponse {
  $type: 'incubus.fantoken.v1beta1.QueryFanTokensResponse';
  fantokens: FanToken[];
...
export interface QueryParamsRequest {
  $type: 'incubus.fantoken.v1beta1.QueryParamsRequest';
}

/** QueryParametersResponse is response type for the Query/Parameters RPC method */
export interface QueryParamsResponse {
  $type: 'incubus.fantoken.v1beta1.QueryParamsResponse';
  params?: Params;
}

function createBaseQueryFanTokenRequest(): QueryFanTokenRequest {
  return { $type: 'incubus.fantoken.v1beta1.QueryFanTokenRequest', denom: '' };
}

export const QueryFanTokenRequest = {
  $type: 'incubus.fantoken.v1beta1.QueryFanTokenRequest' as const,
...
export const QueryFanTokenResponse = {
  $type: 'incubus.fantoken.v1beta1.QueryFanTokenResponse' as const,
...
export const QueryFanTokensRequest = {
  $type: 'incubus.fantoken.v1beta1.QueryFanTokensRequest' as const,
...
export const QueryFanTokensResponse = {
  $type: 'incubus.fantoken.v1beta1.QueryFanTokensResponse' as const,
...
function createBaseQueryParamsRequest(): QueryParamsRequest {
  return { $type: 'incubus.fantoken.v1beta1.QueryParamsRequest' };
}

export const QueryParamsRequest = {
  $type: 'incubus.fantoken.v1beta1.QueryParamsRequest' as const,
...
export const QueryParamsResponse = {
  $type: 'incubus.fantoken.v1beta1.QueryParamsResponse' as const,
...
export class QueryClientImpl implements Query {
  ...
  FanToken(request: QueryFanTokenRequest): Promise<QueryFanTokenResponse> {
    ...
    const promise = this.rpc.request(
      'incubus.fantoken.v1beta1.Query',
      'FanToken',
      data,
    );
